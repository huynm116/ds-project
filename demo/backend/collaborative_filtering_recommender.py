...
#Load dataset
movies_df = pd.read_csv("../../cleaned_data/movies_small.csv", sep=',', index_col=False, dtype='unicode', usecols=['movie_id', 'title', 'img_url'])
df = pd.read_csv("../../cleaned_data/ratings_small.csv", sep=',', index_col=False, dtype='unicode')
